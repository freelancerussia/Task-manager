...
function App() {
    ...
    // const [currentItem, setCurrentItem] = useState<Item | null>(null);
    //
    // const handleDragStart = (board: Board, item: Item) => {
    //     setCurrentBoard(board);
    //     setCurrentItem(item);
    // };
    //
    ...
    return (
        <div className="app">
            ...
            {/*            className="board"*/}
            {/*        >*/}
            {/*            <div className="board__header"><div className="board__title">{board.title}</div> <button onClick={addTaskHandler}>+</button></div>*/}
